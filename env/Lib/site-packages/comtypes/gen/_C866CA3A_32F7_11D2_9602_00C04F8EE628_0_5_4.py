...
__all__ = [
    ...
    'ISpeechRecoContext', 'DISPID_SpeechRecoContext',
    'ISpeechObjectTokens', 'SPDKL_DefaultLocation',
    'DISPID_SpeechPhoneConverter', 'SpeechDiscardType',
    'SDA_No_Trailing_Space', 'DISPID_SRCState', 'DISPID_SPRuleId',
    'DISPID_SRCERecognizerStateChange', 'SAFT48kHz8BitStereo',
    'SITooSlow', 'SGRSTTEpsilon', 'SAFTADPCM_11kHzMono',
    'SPRS_ACTIVE', 'SAFT24kHz8BitStereo', 'IEnumSpObjectTokens',
    'ISpeechLexiconWords', 'DISPID_SVSPhonemeId',
    'DISPID_SpeechMMSysAudio', 'SpeechPartOfSpeech',
    'SpeechAudioVolume', 'SAFTCCITT_uLaw_44kHzStereo',
    'SPEI_HYPOTHESIS', 'DISPID_SASFreeBufferSpace',
    'SpeechFormatType', 'DISPID_SRSNumberOfActiveRules',
    'SPEI_RESERVED5', 'SVPAlert', 'SAFT16kHz8BitMono',
    'DISPID_SPCLangId', 'SPRS_INACTIVE', 'DISPID_SAFSetWaveFormatEx',
    'SpeechTokenShellFolder', 'DISPID_SRRDiscardResultInfo',
    'SPAS_CLOSED', 'SPLEXICONTYPE', 'SDTRule', 'SVSFParseAutodetect',
    'ISpeechPhraseReplacement', 'ISpResourceManager',
    'DISPID_SRGRules', 'DISPID_SRCBookmark', 'DISPID_SRRTimes',
    'SRSEIsSpeaking', 'SRAORetainAudio', 'STSF_CommonAppData',
    'SLODynamic', 'SPEI_RESERVED3', 'SPFM_CREATE_ALWAYS',
    'DISPID_SDKEnumValues', 'DISPID_SREmulateRecognition',
    'DISPID_SLPs_NewEnum', 'SASPause', 'SPEI_TTS_BOOKMARK',
    'SAFTADPCM_8kHzStereo', 'DISPIDSPTSI_SelectionOffset',
    'SPBO_AHEAD', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SLGetGenerationChange', 'DISPID_SRRTStreamTime',
    'SRAExport', 'DISPID_SVEStreamStart', 'SVSFUnusedFlags',
    'DISPID_SVEBookmark', 'SP_VISEME_12', 'DISPID_SpeechDataKey',
    'SWTDeleted', 'DISPID_SRRGetXMLResult', 'SPSERIALIZEDPHRASE',
    'SAFT22kHz8BitStereo', 'SPAUDIOBUFFERINFO', 'SPAO_RETAIN_AUDIO',
    'DISPID_SPRuleNumberOfElements', 'SpeechEmulationCompareFlags',
    'DISPID_SGRSTText', 'SPINTERFERENCE_NOISE', 'SVP_14',
    'SVSFDefault', 'DISPID_SLWPronunciations', 'SPEI_RECOGNITION',
    'DISPID_SRRTOffsetFromStart', 'SPAUDIOSTATUS',
    'DISPID_SGRSTransitions', 'DISPID_SRCVoice',
    'DISPID_SPIProperties', 'DISPID_SOTCEnumerateTokens',
    'SpeechVisemeFeature', 'SRAInterpreter', 'SRADynamic',
    'SpeechTokenContext', 'DISPID_SRAudioInput', 'STSF_AppData',
    'DISPID_SOTCId', 'SWPKnownWordPronounceable',
    'DISPID_SRRSetTextFeedback', 'SPBO_NONE',
    'SPWORDPRONUNCIATIONLIST', 'SPRULE',
    'DISPID_SpeechRecoContextEvents', 'SpNotifyTranslator',
    'DISPID_SDKSetStringValue', 'DISPID_SGRSTType', 'SPRST_ACTIVE',
    'SAFT11kHz16BitMono', 'SPSHT_EMAIL', 'ISpRecognizer',
    'DISPID_SPPsCount', 'DISPID_SMSADeviceId',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPIStartTime',
    'DISPID_SVSLastBookmarkId', 'SAFT8kHz8BitStereo',
    'DISPID_SPPChildren', 'DISPID_SRCResume', 'SSFMOpenReadWrite',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRCEAudioLevel', 'ISpeechPhraseRules', 'SPVPRI_OVER',
    'SDA_Two_Trailing_Spaces', 'DISPID_SpeechBaseStream',
    'tagSTATSTG', 'SPRECOGNIZERSTATUS', 'eLEXTYPE_PRIVATE5',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SAFTCCITT_uLaw_8kHzMono',
    'ISpeechGrammarRule', 'DISPID_SpeechRecognizer', 'SpWaveFormatEx',
    'SAFTGSM610_11kHzMono', 'SPEI_ADAPTATION', 'SPVOICESTATUS',
    'SpeechEngineProperties', 'SPSERIALIZEDRESULT', 'SPCT_COMMAND',
    'DISPID_SpeechVoice', 'DISPID_SVEStreamEnd', 'SVP_9', 'SVP_15',
    'SPBOOKMARKOPTIONS', 'DISPID_SASetState', 'SVEStartInputStream',
    'DISPID_SRCESoundStart', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SPCONTEXTSTATE', 'SVPOver', 'SP_VISEME_10',
    'SpeechDictationTopicSpelling', 'ISpeechAudioBufferInfo',
    'SRAImport', 'IInternetSecurityManager', 'SPEI_MAX_TTS',
    'DISPID_SVGetVoices', 'SpMemoryStream', 'DISPID_SMSGetData',
    'SGRSTTTextBuffer', 'DISPID_SLPPartOfSpeech', 'SVSFNLPSpeakPunc',
    'eLEXTYPE_PRIVATE9', 'SDTLexicalForm', 'DISPID_SDKEnumKeys',
    'SPAR_Low', 'DISPIDSPRG', 'SpeechAddRemoveWord', 'SLTUser',
    'SVP_0', 'DISPID_SpeechLexiconWords',
    'DISPIDSPTSI_SelectionLength', 'SPCT_DICTATION',
    'SAFT12kHz16BitMono', 'SP_VISEME_18', 'DISPID_SpeechPhraseRules',
    'ISpPhoneticAlphabetConverter', 'DISPID_SOTCSetId',
    'SAFTADPCM_44kHzStereo', 'SPLO_STATIC', 'DISPID_SPCIdToPhone',
    'DISPID_SRCVoicePurgeEvent', 'SPEI_RESERVED1',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRGCmdLoadFromMemory', 'SPGS_ENABLED', 'SVP_2',
    'eLEXTYPE_RESERVED6', 'SPEI_TTS_AUDIO_LEVEL',
    'ISpeechLexiconPronunciations', 'SPINTERFERENCE_TOOFAST',
    'SRARoot', 'ISpeechLexicon', 'DISPID_SLPsItem',
    'SAFT44kHz8BitMono', 'ISpeechMemoryStream', 'DISPID_SVSVisemeId',
    'DISPID_SBSRead', 'DISPID_SPRulesItem', 'SPCS_ENABLED',
    'SPSEMANTICERRORINFO', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SOTCGetDataKey', 'SRTSMLTimeout', 'SAFT12kHz8BitMono',
    'SAFTCCITT_ALaw_8kHzStereo', 'SpUnCompressedLexicon',
    'SpeechPropertyLowConfidenceThreshold', 'SREStreamEnd',
    'SAFT8kHz8BitMono', 'DISPID_SAStatus', 'DISPID_SPPsItem',
    'DISPID_SGRSAddRuleTransition', 'SPAR_Medium',
    'SPINTERFERENCE_TOOSLOW', 'ISpProperties', 'DISPID_SOTCDefault',
    'SPDATAKEYLOCATION', 'SPPS_RESERVED3', 'DISPID_SASNonBlockingIO',
    'SP_VISEME_0', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SVAlertBoundary', 'SVP_4', 'SPFM_NUM_MODES',
    'ISpeechGrammarRuleStateTransitions', 'SINone', 'SVPNormal',
    'SpeechTokenKeyUI', 'SGSEnabled', 'DISPID_SLWLangId',
    'DISPID_SMSAMMHandle', 'SPEVENTENUM', 'DISPID_SOTsCount',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVSyncronousSpeakTimeout', 'SPEI_UNDEFINED',
    'eLEXTYPE_USER', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SPPId', 'SPWF_INPUT', 'DISPID_SAVolume',
    'DISPID_SVResume', 'DISPID_SRCERecognition',
    'ISpeechWaveFormatEx', 'DISPID_SRCEHypothesis',
    'SAFT11kHz8BitMono', 'DISPID_SPERetainedSizeBytes', 'SPPS_Noun',
    'SBONone', 'DISPID_SVEPhoneme', 'SAFT32kHz8BitMono',
    'DISPID_SRGCmdLoadFromFile', 'SpObjectTokenCategory',
    'DISPID_SRCEInterference', 'SPAS_STOP',
    'SpeechRecoProfileProperties', 'DISPID_SRCERequestUI',
    'DISPID_SpeechGrammarRule', 'DISPID_SABufferNotifySize',
    'SSFMCreateForWrite', 'DISPID_SASState', 'DISPID_SPRuleParent',
    'SPWAVEFORMATTYPE', 'SPWORDPRONOUNCEABLE',
    'SPEI_SENTENCE_BOUNDARY', '_SPAUDIOSTATE', 'SPSNoun',
    'DISPID_SRSetPropertyString', 'DISPID_SPPNumberOfElements',
    'SREFalseRecognition', 'ISpeechPhraseElements', 'SPEI_MAX_SR',
    'SPCT_SLEEP', 'SVSFIsNotXML', 'DISPID_SLGenerationId',
    'ISpRecoContext2', 'SRATopLevel', 'ISpeechXMLRecoResult',
    'ISpeechPhraseRule', 'STSF_FlagCreate', 'SpNullPhoneConverter',
    'ISpeechLexiconPronunciation', 'SECFDefault',
    'SpeechDisplayAttributes', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SRIsUISupported', 'DISPID_SPPName',
    'DISPID_SDKGetStringValue', 'SAFTNoAssignedFormat',
    'DISPID_SOTIsUISupported', 'SP_VISEME_20', 'SpCompressedLexicon',
    'SPDKL_LocalMachine', 'DISPID_SRRGetXMLErrorInfo', 'SpFileStream',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SPEActualConfidence',
    'SpeechTokenValueCLSID', 'SAFTExtendedAudioFormat',
    'SAFTADPCM_22kHzMono', 'SRSActiveAlways', 'SpAudioFormat',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SPPEngineConfidence',
    'DISPID_SPRules_NewEnum', 'SRCS_Enabled', 'DISPID_SVRate',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SRESoundStart',
    'SPBO_TIME_UNITS', 'DISPID_SPIElements', 'Speech_StreamPos_Asap',
    'SREPropertyNumChange', 'SAFT12kHz16BitStereo', 'SPCATEGORYTYPE',
    'DISPID_SLAddPronunciation', 'SPLOADOPTIONS',
    'SAFT24kHz16BitMono', 'SFTInput', 'DISPID_SASCurrentSeekPosition',
    ...
    'SPWORDTYPE', 'SPAO_NONE', 'SGDSActiveWithAutoPause',
    'SRERecognition', 'DISPID_SVESentenceBoundary', 'DISPID_SPPValue',
    'SRTExtendableParse', 'SPSSuppressWord',
    'ISpeechTextSelectionInformation', 'DISPID_SRRTLength',
    'eLEXTYPE_PRIVATE11', 'SGSDisabled', 'SVP_17',
    'DISPID_SpeechAudioFormat', 'SRSActive',
    'DISPID_SRCEFalseRecognition', '_ISpeechVoiceEvents',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SVSRunningState',
    'SPPS_LMA', 'DISPID_SPRsCount', 'SpeechPropertyAdaptationOn',
    'SREStateChange', 'eLEXTYPE_PRIVATE8', 'eWORDTYPE_ADDED',
    'SVP_12', 'SVP_18', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVAudioOutput', 'SPPS_Function',
    'DISPID_SWFESamplesPerSec', 'SREStreamStart', 'DISPID_SGRId',
    'SpeechGrammarTagUnlimitedDictation', 'SpeechRuleAttributes',
    'SPEI_RESERVED6', 'DISPID_SPRsItem', 'DISPID_SOTId',
    'DISPID_SRGetPropertyString', 'IInternetSecurityMgrSite',
    'ISpNotifyTranslator', 'SpeechPropertyResourceUsage',
    'SPEI_REQUEST_UI', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLWType', 'DISPID_SPRNumberOfElements',
    'DISPID_SLPLangId', 'SPEI_SR_PRIVATE', 'SRSInactive',
    'ISequentialStream', 'SPXMLRESULTOPTIONS', 'DISPID_SOTs_NewEnum',
    'SREAllEvents', 'DISPID_SFSOpen', 'DISPID_SVEventInterests',
    'DISPID_SABIEventBias', 'DISPID_SOTGetDescription',
    'DISPID_SpeechXMLRecoResult', 'SVSFPersistXML',
    'SPGRAMMARWORDTYPE', 'eLEXTYPE_PRIVATE20',
    'DISPID_SVSInputWordPosition', 'SPEI_END_INPUT_STREAM',
    'ISpLexicon', 'SWPUnknownWordPronounceable', 'SPEI_VISEME',
    'SGRSTTWildcard', 'DISPID_SMSALineId',
    'ISpeechRecoResultDispatch', 'SPWORDLIST',
    'DISPID_SLRemovePronunciation', 'SpShortcut', 'SDTDisplayText',
    'eLEXTYPE_PRIVATE10', 'SP_VISEME_21', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRRAudioFormat', 'SpeechRuleState', 'SAFT44kHz8BitStereo',
    'DISPID_SpeechLexiconPronunciation', 'SVSFIsFilename',
    'SpeechUserTraining', 'SVEViseme', 'SAFT22kHz16BitMono',
    'DISPID_SGRSTsItem', 'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SAEventHandle',
    'SASStop', 'ISpeechRecognizer', 'SVEAllEvents', 'DISPID_SGRClear',
    'DISPID_SVSInputSentenceLength', 'DISPID_SpeechPhraseElements',
    'SPEI_WORD_BOUNDARY', 'DISPID_SRCRequestedUIType',
    'SPSEMANTICFORMAT', 'SLOStatic', 'DISPID_SVPause',
    'SpeechCategoryRecognizers', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SRGReset', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SPACommit', 'DISPID_SRCEPhraseStart', 'SSTTTextBuffer',
    'eLEXTYPE_PRIVATE6', 'SPSHT_OTHER',
    'DISPID_SRGSetWordSequenceData', 'SRERecoOtherContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPIRetainedSizeBytes',
    'SAFT32kHz16BitMono', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SREPrivate', 'eWORDTYPE_DELETED', 'SPEI_SOUND_END',
    'SPBINARYGRAMMAR', 'SPAS_PAUSE', 'ISpPhoneConverter',
    'SAFTCCITT_uLaw_11kHzStereo', 'ISpeechObjectToken',
    'DISPID_SPILanguageId', 'DISPID_SPERetainedStreamOffset',
    'SpTextSelectionInformation', 'SDTAll', 'DISPID_SVIsUISupported',
    'SPVISEMES', 'DISPID_SVSLastResult', 'DISPID_SVGetAudioOutputs',
    'SpeechRecoContextState', 'ISpNotifySource',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SPAsCount', 'SGDSActive',
    'DISPID_SGRAttributes', 'DISPID_SWFEBlockAlign',
    'SAFTADPCM_22kHzStereo', 'SPGS_EXCLUSIVE', 'DISPID_SVDisplayUI',
    'DISPID_SPRText', 'SVSFParseMask', 'SAFTNonStandardFormat',
    'DISPID_SOTGetAttribute', 'DISPID_SpeechAudio',
    'DISPID_SCSBaseStream', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRSRule', 'ISpPhrase', 'DISPID_SPAPhraseInfo',
    'DISPID_SRSAudioStatus', 'DISPID_SPERequiredConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_1',
    'ISpeechRecoGrammar', 'DISPID_SABufferInfo',
    'DISPID_SDKDeleteKey', 'DISPID_SRState', 'SPSHORTCUTTYPE',
    'ISpeechVoiceStatus', 'SPPS_Unknown', 'SPEVENT', 'SPVPRIORITY',
    'DISPID_SRRTTickCount', 'STCInprocHandler', 'SPRULESTATE',
    'SSTTDictation', 'DISPID_SpeechVoiceStatus', 'DISPID_SPEsItem',
    'SpeechCategoryAppLexicons', 'DISPID_SBSFormat',
    'DISPID_SLPSymbolic', 'SVP_20', 'SAFTADPCM_11kHzStereo',
    'ISpeechAudio', 'SP_VISEME_5', 'SPGRAMMARSTATE',
    'DISPID_SVSLastBookmark', 'DISPID_SPEs_NewEnum', 'SPCS_DISABLED',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE13',
    'SECFIgnoreWidth', 'ISpStream', 'SPSHT_NotOverriden',
    'SPSTREAMFORMATTYPE', 'DISPID_SPPBRestorePhraseFromMemory',
    'SREBookmark', 'DISPID_SPRFirstElement', 'DISPID_SVEViseme',
    'SWTAdded', 'DISPID_SVSpeak', 'SPPHRASEREPLACEMENT',
    'DISPID_SDKOpenKey', 'DISPID_SOTDisplayUI', 'SPEVENTSOURCEINFO',
    'DISPID_SRCEventInterests', 'DISPID_SRGId', 'DISPID_SPEsCount',
    'SREPropertyStringChange', 'SVP_7', 'SpeechGrammarState',
    'DISPID_SWFEBitsPerSample', 'SVEBookmark', 'DISPID_SBSWrite',
    'SP_VISEME_11', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SGRSTPropertyId', 'DISPID_SRGSetTextSelection',
    'ISpeechBaseStream', 'SDKLLocalMachine',
    'DISPID_SpeechPhraseInfo', 'SpInProcRecoContext', 'ISpeechVoice',
    'SPFM_OPEN_READONLY', 'DISPID_SVAudioOutputStream',
    'DISPID_SGRsItem', 'eLEXTYPE_PRIVATE16', 'SPPHRASERULE',
    'SpeechWordPronounceable', 'SPEI_SOUND_START',
    'ISpeechRecoResult', 'SAFT22kHz8BitMono',
    'SPRS_ACTIVE_USER_DELIMITED', 'SRTEmulated', 'SRCS_Disabled',
    'SAFTGSM610_22kHzMono', 'SSTTWildcard', 'SGPronounciation',
    'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE7',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SP_VISEME_14',
    'SGSExclusive', 'SSFMCreate', 'SGLexical', 'DISPID_SPRs_NewEnum',
    'Speech_StreamPos_RealTime', 'SAFTADPCM_44kHzMono',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SVStatus',
    'DISPID_SRCCreateGrammar', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SRRAudio', 'DISPID_SRCESoundEnd', 'SPWT_DISPLAY',
    'SPRST_INACTIVE', 'DISPID_SRProfile', 'SVSFIsXML',
    ...
    'DISPID_SPEPronunciation', 'SPWT_LEXICAL', 'SpInprocRecognizer',
    'SpeechCategoryAudioOut', 'DISPID_SOTSetId', 'SPEI_MIN_TTS',
    'DISPID_SpeechAudioBufferInfo', 'SpeechDataKeyLocation',
    'DISPID_SpeechPhraseAlternate', 'ISpeechResourceLoader',
    'DISPID_SVPriority', 'SRSEDone', 'SpeechVoiceSpeakFlags',
    'SRAONone', 'eLEXTYPE_MORPHOLOGY', 'SECFIgnoreCase', 'SPAR_High',
    'DISPID_SGRsCommit', 'DISPID_SRCSetAdaptationData',
    'DISPID_SRCEEndStream', 'DISPID_SDKDeleteValue',
    'DISPID_SpeechPhraseReplacements', 'SVSFNLPMask',
    'SVEVoiceChange', 'DISPID_SRGRecoContext',
    'DISPID_SRGIsPronounceable', 'DISPID_SPEDisplayText',
    'ISpEventSource', 'SPPS_NotOverriden', 'DISPID_SRCEBookmark',
    'DISPID_SPIEnginePrivateData', 'ISpRecoContext', 'SGDisplay',
    'SAFT11kHz8BitStereo', 'SDA_One_Trailing_Space',
    'DISPID_SPEAudioSizeTime', 'SpeechTokenIdUserLexicon',
    'SPEI_VOICE_CHANGE', 'DISPID_SGRSTsCount', 'SpMMAudioOut',
    'DISPID_SPRulesCount', 'DISPID_SRGetFormat', 'SPEI_END_SR_STREAM',
    'SPXRO_SML', 'SPWORD', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseProperties', 'DISPID_SGRSTRule',
    'ISpeechMMSysAudio', 'ISpStreamFormat', 'SP_VISEME_13',
    'SPPROPERTYINFO', 'DISPID_SRSClsidEngine', 'IEnumString',
    'SRADefaultToActive', 'SPSMF_SAPI_PROPERTIES', 'SpStream',
    'DISPID_SPIGetText', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SGRsCommitAndSave', 'SpeechAudioFormatGUIDText',
    'ISpeechAudioFormat', 'SPSInterjection', 'SRTStandard',
    'SP_VISEME_19', 'ISpStreamFormatConverter', 'DISPID_SLWs_NewEnum',
    'DISPID_SPIAudioStreamPosition', 'SPEI_PHONEME',
    'DISPID_SGRSAddSpecialTransition', 'ISpRecoResult',
    'DISPID_SAFGuid', 'SLTApp', 'SP_VISEME_3',
    'SpeechGrammarTagWildcard', 'SAFTDefault',
    'SpeechBookmarkOptions', 'DISPID_SGRInitialState',
    'eLEXTYPE_RESERVED4', 'SRESoundEnd', 'SAFT44kHz16BitMono',
    'DISPID_SASCurrentDevicePosition', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVGetAudioInputs', 'DISPID_SRRRecoContext',
    'ISpeechPhraseAlternates', 'ISpNotifySink', 'ISpRecognizer3',
    'DISPID_SLPType', 'ISpObjectToken', '_RemotableHandle',
    'SBOPause', 'SINoise', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechCategoryRecoProfiles', 'SDTAlternates',
    'DISPID_SPEAudioStreamOffset', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SRRSpeakAudio', 'SpLexicon', 'Speech_Max_Word_Length',
    'DISPID_SRCEAdaptation', 'SVEAudioLevel', 'DISPID_SRGCommit',
    'Speech_Default_Weight', 'DISPID_SLGetPronunciations',
    'SPBO_PAUSE', 'SPSModifier', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SpeechPhraseProperties', 'SVSFPurgeBeforeSpeak',
    'SpMMAudioEnum', 'SAFTCCITT_uLaw_8kHzStereo',
    'SECFIgnoreKanaType', 'SPRECORESULTTIMES',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SpeechPhraseBuilder',
    'SAFT16kHz16BitMono', 'ISpeechCustomStream',
    'SGDSActiveUserDelimited', 'SPPS_RESERVED4', 'DISPID_SGRName',
    'SPFILEMODE', 'eLEXTYPE_VENDORLEXICON',
    'SpeechStreamSeekPositionType', 'SpeechInterference',
    'SAFT22kHz16BitStereo', 'SECFEmulateResult',
    'SpSharedRecoContext', 'DISPID_SPAStartElementInResult',
    'DISPID_SRRAlternates', 'ISpeechFileStream',
    'DISPID_SRCRecognizer', 'DISPID_SPAsItem', 'SVP_1',
    'DISPID_SVEEnginePrivate', 'DISPID_SPCPhoneToId', 'SVF_Stressed',
    'SDKLCurrentConfig', '__MIDL_IWinTypes_0009', 'UINT_PTR',
    'DISPID_SRCRetainedAudio', 'ISpeechAudioStatus', 'DISPID_SBSSeek',
    'DISPID_SPISaveToMemory', 'SPINTERFERENCE_NONE', 'SP_VISEME_4',
    'SREAudioLevel', 'SPRST_NUM_STATES', 'SITooLoud', 'SVEPrivate',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPEAudioTimeOffset',
    'SpeechWordType', 'DISPIDSPTSI_ActiveLength',
    'ISpPhoneticAlphabetSelection', 'DISPID_SVWaitUntilDone',
    'DISPID_SVEVoiceChange', 'SpCustomStream', 'SVP_16',
    'STCRemoteServer', 'SPPS_SuppressWord', 'DISPID_SVSpeakStream',
    'SpeechCategoryVoices', 'SPWF_SRENGINE', 'DISPID_SVVolume',
    'SAFT8kHz16BitMono', 'SAFTGSM610_8kHzMono',
    'DISPID_SWFEExtraData', 'DISPID_SOTRemoveStorageFileName',
    'ISpeechPhraseProperty', 'SPAUDIOOPTIONS', 'SDKLCurrentUser',
    'SVEPhoneme', 'SpPhoneticAlphabetConverter', 'ISpRecognizer2',
    'DISPID_SPEDisplayAttributes', 'ISpRecoCategory',
    'DISPID_SVVoice', 'DISPID_SpeechGrammarRules',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SPELexicalForm',
    'SAFTGSM610_44kHzMono', 'SAFT16kHz8BitStereo',
    'DISPID_SPRuleEngineConfidence', 'SPPHRASE', 'WAVEFORMATEX',
    'SREPhraseStart', 'DISPID_SpeechWaveFormatEx',
    'SECFNoSpecialChars', 'eLEXTYPE_PRIVATE2', 'SAFT32kHz16BitStereo',
    'DISPID_SOTRemove', 'SPVPRI_NORMAL', 'SAFTCCITT_uLaw_22kHzMono',
    'SVEWordBoundary', 'SPEI_TTS_PRIVATE', 'DISPID_SPIRule',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPSNotOverriden',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechRecoResult',
    'DISPID_SRRPhraseInfo', 'SGRSTTDictation',
    'SpeechRetainedAudioOptions', 'SAFT8kHz16BitStereo',
    'DISPID_SGRsFindRule', 'SPWORDPRONUNCIATION', 'SpeechVoiceEvents',
    'SPEI_PHRASE_START', 'SPAS_RUN', 'SAFT48kHz16BitMono',
    'DISPID_SPRuleConfidence', 'DISPID_SOTCategory',
    'SVEEndInputStream', 'SPEI_INTERFERENCE', 'eLEXTYPE_PRIVATE12',
    'ISpeechPhraseReplacements', 'SVSFlagsAsync', 'SpResourceManager',
    'DISPID_SRCEStartStream', 'SPCT_SUB_COMMAND',
    'DISPID_SpeechObjectTokens', 'DISPID_SRSCurrentStreamNumber',
    'SITooFast', 'SpeechMicTraining', 'IStream', 'SP_VISEME_17',
    'SGRSTTRule', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SAFT32kHz8BitStereo', 'DISPID_SGRs_NewEnum',
    'ISpeechPhraseElement', 'SWPUnknownWordUnpronounceable',
    'DISPID_SRGetPropertyNumber', 'SPADAPTATIONRELEVANCE',
    'DISPID_SVEWord', 'DISPID_SGRSTs_NewEnum', 'SP_VISEME_9',
    'SDTPronunciation', 'SpeechVoicePriority', 'STCLocalServer',
    'DISPID_SOTsItem', 'DISPID_SMSSetData', 'SP_VISEME_2',
    'SDKLDefaultLocation', 'SPPARTOFSPEECH', 'SPLO_DYNAMIC',
    'SpeechGrammarWordType', 'SPRST_ACTIVE_ALWAYS',
    'SRSInactiveWithPurge', 'SAFT24kHz8BitMono',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPINTERFERENCE_TOOLOUD',
    'SVP_11', 'SAFTTrueSpeech_8kHz1BitMono', 'SpeechAudioState',
    'DISPID_SABIBufferSize', 'SECNormalConfidence', 'ISpRecoGrammar',
    'DISPID_SPPParent', 'SpeechEngineConfidence',
    'SpeechRegistryLocalMachineRoot', 'SPPS_Verb',
    'SPPS_Interjection', 'DISPID_SGRSAddWordTransition', 'SVP_3',
    'DISPID_SPPFirstElement', 'SPSHORTCUTPAIRLIST', 'DISPID_SFSClose',
    'DISPID_SpeechCustomStream', 'DISPID_SABIMinNotification',
    'DISPID_SpeechPhraseReplacement', 'SP_VISEME_6',
    'DISPID_SRGCmdSetRuleState', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_RESERVED2', 'SVP_8', 'DISPID_SGRsCount', 'SITooQuiet',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SpeechRecognizerStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SECLowConfidence',
    'SVP_19', 'eLEXTYPE_RESERVED9', 'ISpPhraseAlt', 'SP_VISEME_7',
    'LONG_PTR', 'SpeechAudioProperties', 'SAFTCCITT_ALaw_11kHzStereo',
    'SPEI_START_INPUT_STREAM', 'SPSLMA',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechStreamFileMode',
    'SVSFParseSapi', 'SpeechAllElements', 'ISpXMLRecoResult',
    'SPSMF_UPS', 'ISpeechObjectTokenCategory',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPIReplacements',
    'SpeechTokenKeyFiles', 'SpeechVisemeType',
    'SpeechTokenKeyAttributes', 'SPGS_DISABLED', 'eLEXTYPE_PRIVATE14',
    'ISpDataKey', '_ISpeechRecoContextEvents', 'DISPID_SpeechLexicon',
    'SAFTADPCM_8kHzMono', 'ISpeechRecognizerStatus',
    'DISPID_SpeechPhraseAlternates', 'ISpeechPhraseInfo',
    'DISPID_SOTGetStorageFileName', 'SVP_6', 'DISPID_SLPPhoneIds',
    'DISPID_SPRuleFirstElement', 'SDA_Consume_Leading_Spaces',
    'DISPID_SRAudioInputStream', 'DISPID_SVSInputSentencePosition',
    'DISPID_SLGetWords', 'DISPID_SPIAudioSizeTime',
    'SpeechVoiceSkipTypeSentence', 'SPEI_START_SR_STREAM',
    'DISPID_SVEAudioLevel', 'ISpGrammarBuilder', 'SSFMOpenForRead',
    'SpPhraseInfoBuilder', 'SVESentenceBoundary', 'SRTReSent',
    'eLEXTYPE_PRIVATE18', 'eLEXTYPE_RESERVED7',
    'SpeechRecognizerState', 'DISPID_SPAs_NewEnum', 'SAFTText',
    'eLEXTYPE_RESERVED10', 'ISpeechGrammarRules',
    'DISPID_SGRAddState', 'DISPID_SGRSTPropertyValue',
    'DISPID_SLWsCount', 'SPRECOSTATE', 'DISPIDSPTSI',
    'DISPID_SDKGetlongValue', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SVGetProfiles', 'SPAUDIOSTATE', 'SGLexicalNoSpecialChars',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SGRsDynamic',
    'SPDKL_CurrentUser', 'tagSPPROPERTYINFO', 'STCAll',
    'ISpeechRecoResult2', 'DISPID_SpeechVoiceEvent', 'SRERequestUI',
    'SAFT16kHz16BitStereo', 'ISpObjectWithToken',
    'SSSPTRelativeToEnd', 'SSSPTRelativeToStart', 'ISpShortcut',
    'SVF_Emphasis', 'SPINTERFERENCE', 'SREInterference',
    'DISPID_SpeechAudioStatus', 'DISPID_SPANumberOfElementsInResult',
    'DISPID_SRCEEnginePrivate', 'SpeechSpecialTransitionType',
    'eLEXTYPE_APP', 'DISPID_SPIGetDisplayAttributes',
    'SpeechCategoryPhoneConverters', 'DISPID_SRDisplayUI',
    'DISPID_SPIGrammarId', 'SINoSignal', 'DISPID_SWFEFormatTag',
    'ISpeechDataKey', 'SASRun', 'DISPID_SLWWord', 'SP_VISEME_15',
    'SPPS_RESERVED2', 'ISpRecoGrammar2', 'DISPID_SAFType',
    'SpPhoneConverter', 'SAFT44kHz16BitStereo', 'SPWT_PRONUNCIATION',
    'SVP_5', 'SVP_10', 'SAFT12kHz8BitStereo',
    'DISPID_SRSetPropertyNumber', 'DISPID_SDKCreateKey', 'SPSVerb',
    'SpVoice', 'DISPID_SRGDictationLoad', 'SP_VISEME_8',
    'STSF_LocalAppData', 'ISpEventSink', 'SPEI_SR_BOOKMARK',
    'DISPID_SGRsAdd', 'SpObjectToken', 'SPPS_RESERVED1',
    'DISPID_SpeechLexiconWord', 'ISpeechLexiconWord',
    'SpeechLoadOption', 'DISPID_SGRSTWeight', 'SP_VISEME_16',
    ...
    'SPDKL_CurrentConfig', 'SVSFVoiceMask',
    'DISPID_SVSInputWordLength', 'DISPID_SRCPause',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SVSpeakCompleteEvent', 'SPSUnknown',
    'SpeechAudioFormatGUIDWave', 'ISpeechGrammarRuleStateTransition',
    'ISpAudio', 'ISpSerializeState', 'SpeechCategoryAudioIn',
    'SpeechLexiconType', 'SpStreamFormatConverter',
    'SECHighConfidence', 'DISPID_SLWsItem', 'SRTAutopause',
    'SPCT_SUB_DICTATION', 'SVP_21', 'SFTSREngine',
    'DISPID_SPRuleName', 'DISPID_SRIsShared',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPIEngineId',
    'DISPID_SPPs_NewEnum', 'SPEI_MIN_SR', 'DISPID_SRGDictationUnload',
    'SPSFunction', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SPRuleChildren',
    'DISPID_SRRecognizer', 'DISPID_SRGState',
    'DISPID_SpeechFileStream', 'SPSHT_Unknown',
    'ISpeechGrammarRuleState', 'SPFM_CREATE',
    'DISPID_SRGDictationSetState', 'SpeechRecoEvents',
    'ISpeechPhraseAlternate', 'SPPS_Modifier',
    'DISPID_SpeechMemoryStream', 'DISPID_SVSkip', 'DISPID_SRStatus',
    'SpeechAudioFormatType', 'SPTEXTSELECTIONINFO',
    'DISPID_SGRSTNextState', 'SDTReplacement', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRCERecognitionForOtherContext', 'ISpVoice',
    'DISPID_SRRSaveToMemory', 'SpSharedRecognizer',
    'SAFT48kHz8BitMono', 'SAFTCCITT_ALaw_8kHzMono',
    'SPPHRASEPROPERTY', 'SPPS_Noncontent', 'SREAdaptation',
    'eLEXTYPE_PRIVATE19', 'DISPID_SDKSetBinaryValue',
    'eLEXTYPE_RESERVED8', 'SGDSInactive', 'ISpObjectTokenCategory',
    'DISPID_SRGetRecognizers', 'eLEXTYPE_PRIVATE1',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPARecoResult',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SASClosed',
    'DISPID_SpeechObjectToken', 'SREHypothesis', 'SVP_13',
    'DISPIDSPTSI_ActiveOffset', 'SPAR_Unknown', 'ISpMMSysAudio',
    'DISPID_SGRSTPropertyName', 'SpeechGrammarTagDictation',
    'SDTProperty', 'SpeechRecognitionType', 'SPVPRI_ALERT',
    'SPSHORTCUTPAIR', 'DISPID_SOTDataKey', 'DISPID_SGRAddResource',
    'DISPID_SpeechRecoResult2',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SADefaultFormat',
    'SVSFParseSsml', 'SPXRO_Alternates_SML', 'SDTAudio',
    'DISPID_SPEEngineConfidence', 'eLEXTYPE_PRIVATE15',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechRunState', 'SVF_None',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRGCmdLoadFromObject',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRCreateRecoContext',
